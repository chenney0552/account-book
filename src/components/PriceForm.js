  ...
  sumbitForm = (event) => {
    ...
    if (price && date && title) {
      if (price < 0) {
        ...
        this.setState({
          validatePass: false,
          errorMessage: 'Please input the correct date format'
        })
      } else {
        this.setState({
          validatePass: true,
      ...
      this.setState({
        validatePass: false,
        errorMessage: 'Please input all the items'
      })
    }
      ...
      <form onSubmit={(event) => {this.sumbitForm(event)}} noValidate>
        <div className="form-group">
          ...
          <input 
            ...
            id="title" placeholder="Please input the title"
            defaultValue={title}
        ...
        <div className="form-group">
          ...
          <div className="input-group">
            ...
            <input 
              ...
              defaultValue={price}
              id="price" placeholder="Please input the price" 
        ...
        <div className="form-group">
          ...
          <input 
            ...
            id="date" placeholder="Please input the date"
            defaultValue={date}
